...
opensdg.chartColors = function(indicatorId) {
  ...
  this.colorSets = {'classic':['7e984f', '8d73ca', 'aaa533', 'c65b8a', '4aac8d', 'c95f44'],
                  'sdg':['AA2B5F', 'FCB513', '9E5EA6', '71BE43'],
...
var mapView = function () {
  ...
  this.initialise = function(indicatorId, precision, precisionItems, decimalSeparator, thousandsSeparator, dataSchema, viewHelpers, modelHelpers, chartTitles, chartSubtitles, startValues, proxy, proxySerieses, allObservationAttributes) {
    ...
    $('#map').sdgMap({
      ...
      mapOptions: {"disaggregation_controls":true,"minZoom":5,"maxZoom":10,"tileURL":"https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png","tileOptions":{"id":"mapbox.light","accessToken":"pk.eyJ1IjoibW9ib3NzZSIsImEiOiJjazU1M2trazQwYnFwM2trYmdwNm9rOWxkIn0.u36w-RJPqoTGmivl_zED1w","attribution":"<a href=\"https://www.openstreetmap.org/copyright\">&copy; OpenStreetMap</a> contributors |<br class=\"visible-xs\"> <a href=\"https://www.bkg.bund.de\">&copy; GeoBasis-De / BKG 2026</a> |<br class=\"hidden-lg\"> <a href=\"https://www.destatis.de/DE/Home/_inhalt.html\">&copy; Statistisches Bundesamt (Destatis), 2026</a>"},"colorRange":[["#edd2de","#dba6be","#c9799e","#b74d7e","#a6215e","#841a4b","#741741","#53102f","#420d25","#210612"],["#fdedd3","#fbdba7","#f9c97b","#f7b74e","#f5a623","#c4841c","#ab7418","#936315","#62420e","#312107"],["#e8deeb","#d1bdd8","#bb9cc4","#a47ab1","#8e5a9e","#71487e","#55365e","#38243f","#1c121f","#0e090f"],["#e4efd9","#cae0b3","#b0d18d","#96c267","#7cb342","#638f34","#567d2e","#3e5921","#253513","#0c1106"]],"noValueColor":"#f0f0f0","styleNormal":{"weight":1,"opacity":1,"color":"#888","fillOpacity":0.7},"styleHighlighted":{"weight":1,"opacity":1,"color":"#111","fillOpacity":0.7},"styleStatic":{"weight":2,"opacity":1,"fillOpacity":0,"color":"#172d44","dashArray":55}},
      mapLayers: [{"serviceUrl":"https://beyondgdp.github.io/bygdp-indicators/assets/maps/boundaries.geojson","min_zoom":4.5,"max_zoom":6.5,"staticBorders":true,"subfolder":"laender","label":"indicator.map"},{"serviceUrl":"https://beyondgdp.github.io/bygdp-indicators/assets/maps/boundariesKrs.geojson","min_zoom":7,"max_zoom":11,"staticBorders":false,"subfolder":"kreise","label":"indicator.map"}],
      precision: precision,
...
function alterDataDisplay(value, info, context, additionalInfo) {
    ...
    console.log("preIf", context, VIEW._graphStepsize, VIEW.graphStepsize != 0 && VIEW.graphStepsize != '');
